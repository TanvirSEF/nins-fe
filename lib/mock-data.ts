...
export const MOCK_GALLERY: GalleryItem[] = [
  {
    ...
    description: "Financial Assistance Distribution Ceremony for Stroke and Paralytic Patients at NINS.",
    imageUrl: "/images/Financial_Assistance_Distribution_Ceremony_for_Stroke_and_Paralysis_Patients.webp",
    r2Key: "gallery/financial-assistance.webp",
  ...
  {
    _id: "gal-002",
    title: "Shahid President Ziaur Rahman Sports Tournament 2026",
    description: "Annual sports and athletics tournament for NINS physicians, staff, and medical students.",
    imageUrl: "/images/Shahid President Ziaur Rahman -Sports Tournament-2026.webp",
    r2Key: "gallery/sports-tournament.webp",
  ...
  {
    _id: "gal-003",
    title: "Routine Inspection Visit by Director",
    description: "Prof. Dr. Mohammad Nuruzzaman Khan inspecting specialized inpatient wards and ICU units.",
    imageUrl: "/images/Routine_Visit_of_Director.webp",
    r2Key: "gallery/director-visit.webp",
  ...
  {
    _id: "gal-004",
    title: "Transport & Bridge Ministry High-Level Delegation Visit",
    description: "Government ministry delegation inspecting NINS infrastructure and emergency transport links.",
    imageUrl: "/images/Transport_and_Bridge_Ministry_Visit.webp",
    r2Key: "gallery/ministry-visit.webp",
    category: GalleryCategory.EVENT,
    isActive: true,
  ...
  {
    _id: "gal-005",
    title: "Pre-Inaugural Inspection & Discussion Meeting",
    description: "Strategic discussion meeting with senior medical faculties and ministry leaders.",
    imageUrl: "/images/Pre_Inaugural_Inspection_Discussion_Meeting_1.webp",
    r2Key: "gallery/inspection-meeting.webp",
    category: GalleryCategory.EVENT,
    isActive: true,
  ...
  {
    _id: "gal-006",
    title: "Health Minister Best Performance Award 2020",
    description: "NINS recognized for outstanding national healthcare service and tertiary neuro care.",
    imageUrl: "/images/dghs-awardex-2020.webp",
    r2Key: "gallery/health-award-2020.webp",
    category: GalleryCategory.ACHIEVEMENT,
    isActive: true,
    createdAt: "2020-12-15T00:00:00Z",
  },
  {
    _id: "gal-007",
    title: "Dengue Awareness & Public Health Seminar",
    description: "Public health awareness drive and seminar on dengue prevention organized by NINS.",
    imageUrl: "/images/dengu_Awarness.webp",
    r2Key: "gallery/dengue-awareness.webp",
    category: GalleryCategory.HEALTH_CAMP,
    isActive: true,
  ...
  {
    _id: "gal-008",
    title: "CMH & NINS Joint Clinical Collaboration Meeting",
    description: "Bilateral medical consultation and knowledge exchange between CMH and NINS specialists.",
    imageUrl: "/images/cmh_nins.webp",
    r2Key: "gallery/cmh-nins.webp",
    category: GalleryCategory.EVENT,
    isActive: true,
  ...
  {
    _id: "gal-009",
    title: "Dhaka University Senate Hall Medical Delegation",
    description: "Academic & medical conference delegation representing NINS at DU Senate Hall.",
    imageUrl: "/images/Dhaka_Senate.webp",
    r2Key: "gallery/dhaka-senate.webp",
    category: GalleryCategory.ACHIEVEMENT,
    isActive: true,
  ...
  {
    _id: "gal-010",
    title: "Public Works Department (PWD) Infrastructure Meeting",
    description: "Discussion on hospital expansion, 10-storied building maintenance, and new ward construction.",
    imageUrl: "/images/PWD-Meeting.webp",
    r2Key: "gallery/pwd-meeting.webp",
    category: GalleryCategory.FACILITY,
    isActive: true,
  ...
  {
    _id: "gal-011",
    title: "NINS Hospital Modern Complex View",
    description: "Exterior view of the 500-bedded 10-storied tertiary care hospital building in Agargaon.",
    imageUrl: "/images/1.webp",
    r2Key: "gallery/nins-building-1.webp",
    category: GalleryCategory.FACILITY,
    isActive: true,
  ...
  {
    _id: "gal-012",
    title: "Neuro-ICU & Critical Care Facilities",
    description: "Advanced life support systems and 24/7 dedicated neuro-intensive care unit.",
    imageUrl: "/images/2.webp",
    r2Key: "gallery/nins-icu-2.webp",
    category: GalleryCategory.FACILITY,
    isActive: true,
  ...
  {
    _id: "gal-013",
    title: "High-Resolution Diagnostic Imaging Suite",
    description: "Neuro-radiology department equipped with 3T MRI, multi-slice CT, and digital angiography.",
    imageUrl: "/images/3.webp",
    r2Key: "gallery/nins-imaging-3.webp",
    category: GalleryCategory.FACILITY,
    isActive: true,
  ...
  {
    _id: "gal-014",
    title: "Specialist OPD & Outpatient Registration Wings",
    description: "Daily specialized OPD clinics serving over 1,000 neurological patients.",
    imageUrl: "/images/4.webp",
    r2Key: "gallery/nins-opd-4.webp",
    category: GalleryCategory.FACILITY,
    isActive: true,
  ...
  {
    _id: "gal-015",
    title: "100-Bedded Comprehensive Stroke Care Unit",
    description: "State-of-the-art dedicated stroke unit for acute thrombolysis and neuro-interventions.",
    imageUrl: "/images/6.webp",
    r2Key: "gallery/nins-stroke-6.webp",
    category: GalleryCategory.FACILITY,
    isActive: true,
  ...
  {
    _id: "gal-016",
    title: "Neurosurgery Operation Theater Complex",
    description: "Sophisticated micro-neurosurgical operating suites equipped with modern microscopes.",
    imageUrl: "/images/7.webp",
    r2Key: "gallery/nins-ot-7.webp",
    category: GalleryCategory.FACILITY,
    isActive: true,

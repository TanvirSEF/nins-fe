...
export const metadata = { title: "Outdoor Patient OPD Services | NINS&H" }

export default function OutdoorPatientPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 space-y-10">
          <div className="flex items-center justify-between border-b border-slate-200/80 pb-4 dark:border-white/10">
            <div className="flex items-center gap-2 text-xs font-semibold text-muted-foreground">
              <Link href="/">Home</Link><span>/</span><span>Services</span><span>/</span><span className="text-foreground font-bold">Outdoor Patient</span>
            </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#164e63] via-[#0e7490] to-[#0f172a] p-8 lg:p-12 text-white shadow-2xl">
            <div className="relative z-10 space-y-3 max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3.5 py-1 text-xs font-semibold text-cyan-200">
                <CalendarCheck className="h-3.5 w-3.5" /> OPD Fast Track Booking
              </div>
              <h1 className="font-heading text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl">Outdoor Patient (OPD) Services</h1>
              <p className="text-sm text-slate-200">OPD ticket registration (8:00 AM - 2:00 PM), consultant room allocations, and online serial booking portal.</p>
            </div>
          </div>
        </div>
      </main>

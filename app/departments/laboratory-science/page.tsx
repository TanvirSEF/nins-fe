...
export const metadata = { title: "Laboratory Science Departments | NINS&H" }

export default function LaboratorySciencePage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 space-y-10">
          <div className="flex items-center justify-between border-b border-slate-200/80 pb-4 dark:border-white/10">
            <div className="flex items-center gap-2 text-xs font-semibold text-muted-foreground">
              <Link href="/">Home</Link><span>/</span><span>Departments</span><span>/</span><span className="text-foreground font-bold">Laboratory Science</span>
            </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#1e3a5f] via-[#2563eb] to-[#0f172a] p-8 lg:p-12 text-white shadow-2xl">
            <div className="relative z-10 space-y-3 max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3.5 py-1 text-xs font-semibold text-blue-200">
                <TestTube className="h-3.5 w-3.5" /> Pathology &amp; Diagnostic Labs
              </div>
              <h1 className="font-heading text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl">Laboratory Science Departments</h1>
              <p className="text-sm text-slate-200">Neuropathology, CSF analysis, immunology, and automated biochemistry laboratory diagnostics.</p>
            </div>
          </div>
        </div>
      </main>

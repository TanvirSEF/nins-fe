...
export const metadata = { title: "Neuro-Physiology Tests (EEG/EMG) | NINS&H" }

export default function NeurophysiologyPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 space-y-10">
          <div className="flex items-center justify-between border-b border-slate-200/80 pb-4 dark:border-white/10">
            <div className="flex items-center gap-2 text-xs font-semibold text-muted-foreground">
              <Link href="/">Home</Link><span>/</span><span>Diagnostic Facilities</span><span>/</span><span className="text-foreground font-bold">Neurophysiology</span>
            </div>
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#1e1b4b] via-[#312e81] to-[#0f172a] p-8 lg:p-12 text-white shadow-2xl">
            <div className="relative z-10 space-y-3 max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3.5 py-1 text-xs font-semibold text-indigo-300">
                <Zap className="h-3.5 w-3.5" /> Electrophysiology Testing Lab
              </div>
              <h1 className="font-heading text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl">Neuro-Physiology Diagnostics</h1>
              <p className="text-sm text-slate-200">Digital EEG, Long-Term Video EEG Monitoring, Nerve Conduction Study (NCS), Electromyography (EMG), and Evoked Potentials (VEP/BAER).</p>
            </div>
          </div>
        </div>
      </main>

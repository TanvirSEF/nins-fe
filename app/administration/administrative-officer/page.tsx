...
export const metadata = {
  title: "Administrative Officer (A.O.) | National Institute of Neurosciences & Hospital",
  description:
    "Official information and contact details of the Administrative Officer (A.O.) at National Institute of Neurosciences & Hospital (NINS&H).",
}

export default function AdministrativeOfficerPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 space-y-10">
          ...
          <div className="flex items-center justify-between border-b border-slate-200/80 pb-4 dark:border-white/10">
            <div className="flex items-center gap-2 text-xs font-semibold text-muted-foreground">
              ...
              <span>/</span>
              <span className="text-foreground font-bold">Administrative Officer (A.O.)</span>
            </div>
          ...
          {/* Hero Banner Section */}
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#1e3a5f] via-[#2d4a6f] to-[#0f172a] p-8 lg:p-12 text-white shadow-2xl">
            <div className="pointer-events-none absolute top-0 right-0 h-96 w-96 rounded-full bg-primary/20 blur-3xl" />
            
            <div className="relative z-10 space-y-3 max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3.5 py-1 text-xs font-semibold text-blue-300 backdrop-blur-md">
                <Building2 className="h-3.5 w-3.5" />
                Administrative Officer (A.O.) • Section Oversight
              </div>
              ...
              <p className="text-sm sm:text-base text-slate-300 font-medium leading-relaxed">
                Handling personnel files, official correspondence, government tenders, and establishment section logistics at NINS&amp;H.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-12 items-start">
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="overflow-hidden rounded-3xl border border-slate-200/80 bg-white p-5 shadow-xl dark:border-white/10 dark:bg-slate-900 space-y-4">
                <div className="relative mx-auto h-56 w-full overflow-hidden rounded-2xl border border-slate-300 bg-slate-100 dark:border-white/15 dark:bg-slate-950 flex items-center justify-center">
                  <div className="text-center p-6 space-y-2">
                    <FileCheck className="h-16 w-16 text-primary mx-auto opacity-80" />
                    <span className="block font-heading text-base font-bold text-foreground">A.O. Section</span>
              ...
              <div className="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-xl space-y-4 dark:border-white/10 dark:bg-slate-900">
                ...
                <div className="space-y-3 text-xs">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="block text-[10px] font-bold text-muted-foreground uppercase">PABX Extension</span>
                      <span className="font-bold text-foreground">+880-02-41024584 (Ext. 210)</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="font-semibold text-foreground">ao@nins.gov.bd</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className="font-medium text-foreground">2nd Floor, Room 212, NINS</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Right Column: Key Administrative Sections (8 Cols) */}
                ...
                <div className="flex items-center gap-3 border-b border-slate-100 pb-4 dark:border-white/5">
                  ...
                  <div>
                    <h3 className="font-heading text-lg font-bold text-foreground">
                      Administrative Officer (A.O.) Key Functions
                    </h3>
                    <p className="text-xs text-muted-foreground">
                      Establishment, service books, NOC processing &amp; official circulars
                    </p>
                  </div>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2 text-xs">
                  <div className="rounded-2xl border border-slate-100 bg-slate-50/70 p-4 space-y-2 dark:border-white/5 dark:bg-slate-950">
                    <div className="flex items-center gap-2 text-primary font-bold">
                      ...
                      Establishment &amp; Service Records
                    </div>
                    <p className="text-muted-foreground leading-relaxed">
                      Maintaining service books for 300+ doctors, nurses &amp; staff members, promotion papers, and retirement pension files.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-100 bg-slate-50/70 p-4 space-y-2 dark:border-white/5 dark:bg-slate-950">
                    <div className="flex items-center gap-2 text-info font-bold">
                      ...
                      Passport &amp; NOC Verifications
                    </div>
                    <p className="text-muted-foreground leading-relaxed">
                      Processing No Objection Certificates (NOC) for foreign training, higher education, and passport applications.
                    </p>
                  </div>
                </div>
              </div>
